...
function colors(color) {
    ...
    if (color === "blue" || color === "red" || color === "green" || color === "orange") { return "This is " + color } else { return "Color not found" }
}
...
function tieneTresDigitos(numero) {
    ...
    //Escribe tu código aquí
    return ((String(numero)).length === 3 ? true : false)
}
